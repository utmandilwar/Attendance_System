      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <ol class="text-left">
            ...
            <li>Roll to the <button class="btn">A</button> button to mark that student as absent</li>
            <li>Roll to the <button class="btn btn-success">P</button> button to mark the student as present</li>
            <li>Roll to the <button class="btn btn-danger">&times;</button> button to delete that roll number (can't undo this action)</li>
            <li>Roll to the <button class="btn btn-success">Send</button> button at top to save your attendance details</li>
          </ol>
        </div>
      </div>
    </div>
