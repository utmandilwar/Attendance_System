...
<body>
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <img src="scelogo.jpg" alt="Welcome to SCE" width="80" height="80" margin-left:"-50px";>
        <h2><a class="navbar-brand" href="index.php" style="font-size:28px; font-family: Impact, 'Arial Narrow Bold', sans-serif">Sapthagiri College of Engineering</a></h2>
        <a class="navbar-brand" href="index.php" style="font-family:sans; padding-left: 100px"><i> ~Classroom for a better future! </i></a>
      </div>
  ...
  <div class="container">
    ...
    echo '<br><br><br><h1 style="margin-top:55px; font-family: Mistral">Welcome, ' . $name . '.</h1>';
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div id="add_class_form">
          ...
          <input class="form-control" name="code" placeholder="Code , Eg : ISE-051">
          ...
          <input class="form-control" name="start" placeholder="Starting Roll Number (Eg. 001/IS/18)">
          <input class="form-control" name="end" placeholder="Ending Roll Number (Eg. 150/IS/18)">
